              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Positioned(
                    right: 15,
                    top: -5,
                    child: Image.asset("assets/shop/img_01.png",
...
//     BubbleBottomBarItem(
//       backgroundColor: Colors.black,
//       icon: Icon(CustomIcons.products, color: Colors.black),
//       acitveIcon: Icon(CustomIcons.products, color: Colors.white),
//       title: Text("Home", style: bottomBarItemStyle,)
//     ),
//      BubbleBottomBarItem(
//       backgroundColor: Colors.black,
//       icon: Icon(Icons.favorite_border, color: Colors.black),
//       acitveIcon: Icon(Icons.favorite_border, color: Colors.white),
//       title: Text("Favorite", style: bottomBarItemStyle,)
//     ),
//      BubbleBottomBarItem(
//       backgroundColor: Colors.black,
//       icon: Icon(Icons.person, color: Colors.black),
//       acitveIcon: Icon(Icons.person, color: Colors.white),
